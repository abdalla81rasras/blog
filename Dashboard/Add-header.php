            ...
            <div class="col-md-6 p-md-0">
                <div class="welcome-text">
                    <?php if($update==true && $edit==true): ?>
                        <h4>Update Logo Header & Tab</h4>
                    <?php else: ?>
                        <h4>Add New Logo Header & Tab</h4>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                    ...
                    <div class="basic-form">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label class="text-dark">Image Or Icon Tab :</label>
                                <div class="custom-file">
                                    <input type="file" class="form-control-file" accept="Image/*" name="img_tab">
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                <label class="text-dark">Title Tab :</label>
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label class="text-dark">Name Logo :</label>
